...
public class Mapbox_Streets_OSMStyle extends Mapbox_BasicMercatorTiledImageLayer {
    static String strName = "Mapbox_Streets_OSMStyle";

    public Mapbox_Streets_OSMStyle() {
        super(makeLevels());
        this.splitScale = 1.3;
    }
    ...
    private static LevelSet makeLevels() {
        ...
        params.setValue(AVKey.SERVICE, "https://api.mapbox.com/styles/v1/airportmaster/cirzc39ca000ig9m1mg6vmx1c/tiles/256/");
