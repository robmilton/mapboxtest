 ...
 */
public class Mapbox_Black_2 extends BasicMercatorTiledImageLayer
{
    public Mapbox_Black_2()
    {
        super("Mapbox_Black_2", "Earth/Mapbox_Black_2", 19, 256, false, ".png", new URLBuilder());
    }
    ...
    private static class URLBuilder extends MercatorTileUrlBuilder
    {
        ...
        {
            return new URL("https://api.mapbox.com/styles/v1/airportmaster/cjhjerqz72m0e2smwjmlzm5sm/tiles/256/" + z + "/" + x + "/" + y + "?access_token=" + accessToken);
        }
    }
